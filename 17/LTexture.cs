...
namespace SdlExample
{
    ...
    public class LTexture
    {
        ...
        public void Render(int x, int y, SDL.SDL_Rect? clip, double angle = 0, SDL.SDL_Point? center = null, SDL.SDL_RendererFlip flip = SDL.SDL_RendererFlip.SDL_FLIP_NONE)
        {
