...
namespace _25
{
    class Program
    {
        ...
        private const int SCREEN_FPS = 25;
        private const int SCREEN_TICK_PER_FRAME = 1000 / SCREEN_FPS;
            ...
            else
            {
                ...
                else
                {
                    ...
                    while (!quit)
                    {
                        ...
                        timeText = "";
                        timeText += "Average Frames Per Second (With Cap) " + string.Format("{0:.0000}", avgFPS);
                        ...
                        {
                            //Wait remaining time
                            SDL.SDL_Delay(SCREEN_TICK_PER_FRAME - frameTicks);
                        }
                    }
                }
            }
